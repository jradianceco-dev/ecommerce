  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-radiance-creamBackgroundColor">
        ...
        <section
          className="relative w-full min-h-[85vh] pt-20 flex items-center overflow-hidden"
          aria-label="Hero section"
        >
          {/* Background Image */}
          <div className="absolute inset-0 z-0">
            <Image
              src="/beautiful-spa-composition-brown-wall-space-text.png"
              alt="JRADIANCE premium organic skincare and beauty products"
              fill
              className="object-cover"
              priority
            />
            {/* Soft overlay gradient - More image visibility */}
            ...
            <div className="max-w-2xl">
              ...
              <div className="grid grid-cols-3 gap-4 md:gap-6 py-20 mt-12">
                <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 md:p-5 text-center border border-white/50 shadow-sm">
                  <div className="text-3xl md:text-4xl font-black text-radiance-goldColor mb-1">
                    10K+
                  </div>
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="sr-only">
              <h2>
                Why Shop at JRADIANCE - Premium Organic Skincare & Body Care
                Products
              </h2>
              <p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {categories.map((category) => (
                ...
                >
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-linear-to-t ${category.gradient}`}
                  />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="text-lg text-gray-600 space-y-4">
              ...
              <p>
                ...
                Nigeria's premier online store for authentic skincare and
                cosmetics. Free delivery on orders over ₦50,000.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  distributors. Every product is verified for authenticity and
                  quality.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  support, easy returns, and a loyalty program that rewards you.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  We curate only the finest products that meet our strict
                  standards. Quality is not just a promise, it's our guarantee.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg">
              ...
              <p className="text-lg text-gray-600 mb-8">
                ...
                tips, and early access to new arrivals.
              </p>
        ...
        <section className="py-20 px-24 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join thousands of happy customers who trust JRADIANCE for their
              beauty needs.
            </p>
            <Link
              href="/shop"
